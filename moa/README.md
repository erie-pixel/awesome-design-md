...
| **앨범 암호화 (선택)** | 새 앨범을 만들 때 켜거나, 쓰던 앨범을 나중에 켜고 끌 수 있어요. 사진·영상·썸네일·앨범 정보가 모두 기기에서 암호화된 뒤 올라가서 GitHub에서는 이름·날짜·장소·사진 내용을 볼 수 없어요. 암호를 잊으면 **복구 코드**로 열어요 |
...
- **암호를 잊었을 때**
  ...
  - 셋 다 없으면(암호·복구 코드·열려 있는 기기) **복구할 수 없어요.** 저도, GitHub도 풀 수 없어요.
